...
public class TypedReaderImageMono16 : IDisposable {
  private HandleRef swigCPtr;
  protected bool swigCMemOwn;

  internal TypedReaderImageMono16(IntPtr cPtr, bool cMemoryOwn) {
  ...
  public new ImageMono16 read(bool shouldWait) {
    IntPtr cPtr = yarpPINVOKE.TypedReaderImageMono16_read__SWIG_0(swigCPtr, shouldWait);
    ImageMono16 ret = (cPtr == IntPtr.Zero) ? null : new ImageMono16(cPtr, false);
    return ret;
  }

  public new ImageMono16 read() {
    IntPtr cPtr = yarpPINVOKE.TypedReaderImageMono16_read__SWIG_1(swigCPtr);
    ImageMono16 ret = (cPtr == IntPtr.Zero) ? null : new ImageMono16(cPtr, false);
    return ret;
  }
  ...
  public new ImageMono16 lastRead() {
    IntPtr cPtr = yarpPINVOKE.TypedReaderImageMono16_lastRead(swigCPtr);
    ImageMono16 ret = (cPtr == IntPtr.Zero) ? null : new ImageMono16(cPtr, false);
    return ret;
  }
  ...
  public virtual System.IntPtr acquire() { return yarpPINVOKE.TypedReaderImageMono16_acquire(swigCPtr); }

  public virtual void release(System.IntPtr handle) {
    yarpPINVOKE.TypedReaderImageMono16_release(swigCPtr, handle);
  }
