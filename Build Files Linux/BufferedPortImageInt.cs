...
public class BufferedPortImageInt : Contactable {
  ...
  internal BufferedPortImageInt(IntPtr cPtr, bool cMemoryOwn) : base(yarpPINVOKE.BufferedPortImageInt_SWIGUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new HandleRef(this, cPtr);
  }

  internal static HandleRef getCPtr(BufferedPortImageInt obj) {
  ...
  public new ImageInt read(bool shouldWait) {
    IntPtr cPtr = yarpPINVOKE.BufferedPortImageInt_read__SWIG_0(swigCPtr, shouldWait);
    ImageInt ret = (cPtr == IntPtr.Zero) ? null : new ImageInt(cPtr, false);
    return ret;
  }

  public new ImageInt read() {
    IntPtr cPtr = yarpPINVOKE.BufferedPortImageInt_read__SWIG_1(swigCPtr);
    ImageInt ret = (cPtr == IntPtr.Zero) ? null : new ImageInt(cPtr, false);
    return ret;
  }

  public new ImageInt lastRead() {
    IntPtr cPtr = yarpPINVOKE.BufferedPortImageInt_lastRead(swigCPtr);
    ImageInt ret = (cPtr == IntPtr.Zero) ? null : new ImageInt(cPtr, false);
    return ret;
  }
  ...
  public virtual System.IntPtr acquire() { return yarpPINVOKE.BufferedPortImageInt_acquire(swigCPtr); }

  public virtual void release(System.IntPtr handle) {
    yarpPINVOKE.BufferedPortImageInt_release(swigCPtr, handle);
  }
  ...
  public override Property acquireProperties(bool readOnly) {
    IntPtr cPtr = yarpPINVOKE.BufferedPortImageInt_acquireProperties(swigCPtr, readOnly);
