...
public class RateThreadWrapper : RateThread {
  ...
  internal RateThreadWrapper(IntPtr cPtr, bool cMemoryOwn) : base(yarpPINVOKE.RateThreadWrapper_SWIGUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new HandleRef(this, cPtr);
  }

  internal static HandleRef getCPtr(RateThreadWrapper obj) {
  ...
  public SWIGTYPE_p_Runnable getAttachment() {
    IntPtr cPtr = yarpPINVOKE.RateThreadWrapper_getAttachment(swigCPtr);
    SWIGTYPE_p_Runnable ret = (cPtr == IntPtr.Zero) ? null : new SWIGTYPE_p_Runnable(cPtr, false);
    return ret;
  }
