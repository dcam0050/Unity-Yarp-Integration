...
public class DVector : global::System.IDisposable, global::System.Collections.IEnumerable
    , global::System.Collections.Generic.IList<double>
 {
  ...
  public DVector(global::System.Collections.ICollection c) : this() {
    if (c == null)
  ...
  public DVector GetRange(int index, int count) {
    global::System.IntPtr cPtr = yarpPINVOKE.DVector_GetRange(swigCPtr, index, count);
  ...
  public static DVector Repeat(double value, int count) {
    global::System.IntPtr cPtr = yarpPINVOKE.DVector_Repeat(value, count);
    DVector ret = (cPtr == global::System.IntPtr.Zero) ? null : new DVector(cPtr, true);
    if (yarpPINVOKE.SWIGPendingException.Pending) throw yarpPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
