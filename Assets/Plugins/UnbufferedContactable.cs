...
public class UnbufferedContactable : Contactable {
  ...
  internal UnbufferedContactable(IntPtr cPtr, bool cMemoryOwn) : base(yarpPINVOKE.UnbufferedContactable_SWIGUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new HandleRef(this, cPtr);
  }

  internal static HandleRef getCPtr(UnbufferedContactable obj) {
